...
public static class ExternalData
{
    public static void WriteTxt()
    {
        ...
        sw.WriteLine("I didn't think this was going to be the way I lose you. Two weeks ago you were fine. A week ago you said you were feeling sick. And now...");
        sw.WriteLine("I feel so alone. Loneliness feels almost tangible, weighing down the air around me.");
        sw.WriteLine("It's lurking around every corner, waiting for those quiet moments so it can curl around me, suffocate me.");
        sw.WriteLine("I don't know how I'm supposed to do this without you now. No job, stuck alone in this house for the next two weeks, and even after that...");
        sw.WriteLine("*sigh*");
        sw.WriteLine("Maybe I should try get some sleep again. Maybe things will be better tomorrow.");
